document.addEventListener("DOMContentLoaded", function () {
  ...
  resultsHeading.textContent = `Quick Search Results for: ${searchQuery}`;
  ...
  quickSearchButton.addEventListener('click', function (event) {
    ...
    if (results.length === 0) {
      ...
      resultsHeading.textContent = `Quick Search Results for: ${query}`;
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Check if user is logged in and redirect to c-search-page.html if true
