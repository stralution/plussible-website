document.addEventListener("DOMContentLoaded", function() {
  ...
  function renderOffers(offers, page = 1) {
      ...
      // Add event listeners for the "Engage Service" buttons
      const engageButtons = document.querySelectorAll('.engage-btn');
      engageButtons.forEach(button => {
          button.addEventListener('click', function(event) {
              event.preventDefault();
              alert('You need to sign in to engage service. This is the beta stage of this product.');
          });
      });
  }
